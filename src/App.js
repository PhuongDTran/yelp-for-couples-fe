  ...
  return (
    <div className="App" style={{ display: 'flex', flexDirection: 'column' }}>
      <div style={{ width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
        <div style={{border: '1px solid red',  display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
          <TextField
            size="small"
            variant="standard"
            InputProps={{
          ...
          <TextField
            ...
            InputProps={{
              disableUnderline: true,
              startAdornment: <InputAdornment position="start"><IconButton color="primary" onClick={handleCurrentLocation}> <LocationOnOutlinedIcon/> </IconButton></InputAdornment>,
            }}
            value={searchText}
            onChange={e => setSearchText(e.target.value)}
          />
